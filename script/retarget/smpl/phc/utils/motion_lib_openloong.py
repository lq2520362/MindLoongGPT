...
from script.retarget.smpl.phc.utils import torch_utils
from script.retarget.smpl.phc.utils.flags import flags
from script.retarget.smpl.phc.utils.motion_lib_base import (DeviceCache,
                                                            FixHeightMode,
                                                            MotionLibBase)
from script.retarget.smpl.phc.utils.torch_openloong_humanoid_batch import \
    Humanoid_Batch
...
class MotionLibLoong(MotionLibBase):
    ...
    def __init__(self, motion_file, device, fix_height=FixHeightMode.no_fix, masterfoot_conifg=None, min_length=-1, im_eval=False, multi_thread=True, extend_hand = True, extend_head = False, mjcf_file="resources/robots/h1/h1.xml", sim_timestep = 1/50):
        ...
        self.mesh_parsers = Humanoid_Batch(mjcf_file=mjcf_file)
        return
