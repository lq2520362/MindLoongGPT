...
for path in paths:
    ...
    for idx in range(num_seqs):
        ...
        all_poses.append(new_opt_pose.cpu())
        # print("shape: ",new_opt_pose.size())
    ...
    all_poses_tensor = torch.cat(all_poses, dim=0)  # shape: [192, 72]
    np.save(os.path.join(dir_save, "all_poses.npy"), all_poses_tensor.numpy())
